...
#ifndef ESSENTIALSAI_SWIFT_H
#define ESSENTIALSAI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EssentialsAI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS_NAMED("AIContentNative")
@interface AIContentNative : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSString;
SWIFT_PROTOCOL_NAMED("AIToolNative")
...
SWIFT_CLASS_NAMED("CancellationTokenNative")
...
typedef SWIFT_ENUM_NAMED(NSInteger, ChatClientError, "ChatClientError", open) {
  ChatClientErrorEmptyMessages = 1,
  ChatClientErrorInvalidRole = 2,
  ChatClientErrorInvalidContent = 3,
  ChatClientErrorCancelled = 4,
};

@class ChatMessageNative;
@class ChatOptionsNative;
@class ResponseUpdateNative;
@class ChatResponseNative;
@class NSError;
SWIFT_CLASS_NAMED("ChatClientNative")
...
enum ChatRoleNative : NSInteger;
SWIFT_CLASS_NAMED("ChatMessageNative")
...
@class NSNumber;
SWIFT_CLASS_NAMED("ChatOptionsNative")
...
SWIFT_CLASS_NAMED("ChatResponseNative")
...
typedef SWIFT_ENUM_NAMED(NSInteger, ChatRoleNative, "ChatRoleNative", open) {
  ChatRoleNativeUser = 1,
  ChatRoleNativeAssistant = 2,
  ChatRoleNativeSystem = 3,
  ChatRoleNativeTool = 4,
};

SWIFT_CLASS_NAMED("FunctionCallContentNative")
...
SWIFT_CLASS_NAMED("FunctionResultContentNative")
...
enum ResponseUpdateTypeNative : NSInteger;
SWIFT_CLASS_NAMED("ResponseUpdateNative")
...
- (nonnull instancetype)initWithUpdateType:(enum ResponseUpdateTypeNative)updateType text:(NSString * _Nullable)text toolCallId:(NSString * _Nullable)toolCallId toolCallName:(NSString * _Nullable)toolCallName toolCallArguments:(NSString * _Nullable)toolCallArguments toolCallResult:(NSString * _Nullable)toolCallResult OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM_NAMED(NSInteger, ResponseUpdateTypeNative, "ResponseUpdateTypeNative", open) {
  ResponseUpdateTypeNativeContent = 0,
  ResponseUpdateTypeNativeToolCall = 1,
  ResponseUpdateTypeNativeToolResult = 2,
};

SWIFT_CLASS_NAMED("TextContentNative")
